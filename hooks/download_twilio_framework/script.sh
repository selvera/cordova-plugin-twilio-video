...
printf "\n** download completed **"
printf "\n** extracting **"
unzip plugins/cordova-plugin-twilio-video/src/frameworks/twilio/TwilioVideo.framework.zip -d src/frameworks/twilio/
mv plugins/cordova-plugin-twilio-video/src/frameworks/twilio/Build/iOS/TwilioVideo.framework src/frameworks/twilio/
printf "\n** extracting complete **"